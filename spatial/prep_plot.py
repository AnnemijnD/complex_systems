...
# ss = [{1:0.93, 2:0.93}, {1:0.92, 2:0.92},
# {1:0.91, 2:0.91}, {1:0.9, 2:0.9},{1:0.8, 2:0.8}, {1:0.7, 2:0.7},
# {1:0.6, 2:0.6}, {1:0.5, 2:0.5}]
# ss = [ {1:0.9, 2:0.9}, {1:0.8, 2:0.8}, {1:0.7, 2:0.7}, {1:0.6, 2:0.6}]
...
plt.subplot(121)
plt.errorbar(xaxis, means_pol, yerr=stdevs_pol)
plt.xticks(np.arange(5), ('Tom', 'Dick', 'Harry', 'Sally', 'Sue'))

plt.subplot(122)
plt.errorbar(xaxis, means_spec, yerr=stdevs_spec)
plt.xticks([0,1,2,3,4,5], labels=[1.0, 0.9, 0.8, 0.7, 0.6, 0.5])
